...
$Progcmd = 'python C:\Users\rtome\PycharmProjects\SISEzad1\sise\main.py'
...
Get-ChildItem -File | Where-Object { $_.Name -match $SolFilenameRegex } | ForEach-Object {
    ...
    Invoke-Expression $('{0} {1} {2} {3} {4}' -f $Progcmd, $InitFilename, $_.Name, "additional_arg1", "additional_arg2")
